...
{
    public:
    ConfigExdiGdbServerHelperImpl(): m_XmlLiteReader(nullptr), m_IStream(nullptr)
    {
        ZeroMemory(&m_ExdiGdbServerData, sizeof(ConfigExdiGdbSrvData));
    }

    ~ConfigExdiGdbServerHelperImpl()
    {
    }

    //  This function will read the file/default memory and load the 
    //  table with the values.
    bool ReadConfigFile(_In_opt_ PCWSTR pXmlConfigFile)
    {
    ...
    inline void GetExdiComponentAgentNamePacket(_Out_ wstring & packetName)
    {
        packetName = m_ExdiGdbServerData.component.agentNamePacket;
    }

    inline void GetExdiComponentUuid(_Out_ wstring & uuid)
    {
        uuid = m_ExdiGdbServerData.component.uuid;
    }

    inline bool GetDisplayCommPacketsCharacters()
    {
        return m_ExdiGdbServerData.component.fDisplayCommPackets;
    }

    inline bool GetDebuggerSessionByCore()
    {
        return m_ExdiGdbServerData.component.fDebuggerSessionByCore;
    }

    inline TargetArchitecture GetTargetArchitecture()
    {
        return m_ExdiGdbServerData.target.targetArchitecture;
    }

    inline DWORD GetTargetFamily()
    {
    ...
    LPCWSTR GetXmlBuffer()
    {
        //  We won't implement it by using a memory xml buffer.
        return nullptr;
    }

    HRESULT CreateStream(_In_opt_ PCWSTR pXmlConfigFile)
    {
        HRESULT hr = S_OK;
    ...
    HRESULT GetXmlTagAttributeValues(_In_ TAG_ATTR_LIST * const pTagAttrList, 
    ...
    void ClearTagAttributesList(_Inout_ TAG_ATTR_LIST * const pTagAttrList)
    {
    ...
    HRESULT HandleTagAttributeList(_In_ TAG_ATTR_LIST * const pTagAttrList)
    {
        assert(pTagAttrList != nullptr);
        HRESULT hr = E_FAIL;
    ...
    HRESULT ProcessAttributeList(_In_ TAG_ATTR_LIST * const pTagAttrList)
    {
        HRESULT hr = E_FAIL;
        __try
        {
    ...
    HRESULT ParseAttributes(_Inout_ TAG_ATTR_LIST * pTagAttrList)
    {
        assert(pTagAttrList != nullptr);
        HRESULT hr = E_FAIL;
